...
- monitoring: prod=191/192 (192.168.10.91/.92), qa=391/392 (192.168.30.91/.92) — *qa relocated 2026-05-30, prod relocated 2026-06-05, both off the legacy x95/x96 slots that the 2026-05-20 traefik-lxc rollout claimed (CT 195/395 are now traefik-lxc-blue). Prod move also fixed the recurring CT-196 NFS-wedge → grafana 503 outages. **dev monitoring is still at the legacy slot — dev=`monitoring-green` 296 (192.168.20.96), coexisting with traefik-lxc-blue at 295 — and should be migrated to 291/292 next time the dev stack is touched** (same collision + wedge risk). See `/app/reports/2026-05-30-grafana-recovery.md` and `/app/reports/2026-06-05-grafana-newrelic-audit.md`.*
